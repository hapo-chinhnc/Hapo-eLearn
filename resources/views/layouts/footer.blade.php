        <footer class="container-fluid hapolearn-footer mt-5">
            <div class="row p-lg-5 p-md-4 p-3 d-flex justify-content-lg-around">
                <div class="col-md-4 col-8 order-md-0 order-1 no-gutters-custom mb-2 mb-md-0">
                    <img src="{{ url('storage/images/Hapo_Learn_white1.png') }}" class="img-fluid">
                ...
                <div class="col-lg-4 col-md-3 col-4 d-flex justify-content-md-center align-items-md-center order-md-2 order-2 mt-3 mt-md-0">
                    <img src="{{ url('storage/images/fb.png') }}" class="hapolearn-footer-icon" data-toggle="tooltip" data-placement="top" title="facebook.com/tuyen.dung.haposoft">
                    <img src="{{ url('storage/images/phone.png') }}" class="hapolearn-footer-icon" data-toggle="tooltip" data-placement="top" title="+84-85-645-9898">
                    <img src="{{ url('storage/images/mail.png') }}" class="hapolearn-footer-icon" data-toggle="tooltip" data-placement="top" title="info@haposoft.comm">
                </div>
            </div>
        ...
        <section class="hapolearn-messenger row">
            <div class="hapolearn-messenger-chatbox p-2 col-12" id="chat">
                ...
                <div class="hapolearn-messenger-chatbox-text row">
                    <img src="{{ url('storage/images/ower-small.png') }}" alt="" class="col m-auto">
                ...
                <div class="hapolearn-messenger-chatbox-login col-10 m-auto pt-3">
                    <button class="btn btn-primary w-100 hapolearn-messenger-btnlogin p-2"><img src="{{ url('storage/images/messeger.png') }}" class="mr-1">Đăng nhập vào Messenger</button>
                    <p class="mt-2">Chat với HapoLearn trong Messenger</p>
                </div>
            </div>
            <div class="col-12 pr-0">
                <img src="{{ url('storage/images/messengerz.png') }}" class="float-right hapolearn-messenger-icon" id="btn-mess">
            </div>
        </section>
