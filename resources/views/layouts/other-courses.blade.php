<div class="hapolearn-title text-center w-100"><span class="hapolearn-title-borderbottom">Other Courses</span></div>
    ...
    <div class="w-100 text-center mt-md-5"><a href="{{ route('courses.index') }}" class="hapolearn-allcourses text-decoration-none">View All Our Courses<img src="{{ asset('storage/images/arrow.png') }}" class="ml-3"></a></div>
</main>
